...
#
Company.seed(:id,
  {"id"=>1, "name"=>"Nitzsche-Streich", "description"=>"Future-proofed user-facing migration", "address"=>"Suite 605 558 Kohler Route, Wallaceland, TX 13052", "website_url"=>"http://doyle.io/ted_beahan"},
  {"id"=>2, "name"=>"Legros-Padberg", "description"=>"Quality-focused fresh-thinking budgetary management", "address"=>"92858 Ernesto Orchard, Port Woodrowborough, MO 21833", "website_url"=>"http://miller.io/augustus"},
  {"id"=>3, "name"=>"Metz, Hermann and Renner", "description"=>"Enhanced asymmetric software", "address"=>"406 Watsica Path, Dachmouth, OR 23848", "website_url"=>"http://abernathy.io/ranee_steuber"},
  {"id"=>4, "name"=>"Bosco-Metz", "description"=>"Horizontal 6th generation portal", "address"=>"785 Katherine Ports, Rosenbaumberg, WA 84654", "website_url"=>"http://willmsboyer.org/daron.runolfsdottir"},
  {"id"=>5, "name"=>"Turner LLC", "description"=>"Total content-based neural-net", "address"=>"Apt. 571 8321 Jules Tunnel, New Cordelia, TN 60860-4359", "website_url"=>"http://klockofeest.org/rolando"},
  {"id"=>6, "name"=>"Boyer-Bogisich", "description"=>"Managed content-based archive", "address"=>"6790 Trudie Throughway, East Iselashire, ME 65252-1195", "website_url"=>"http://dachmosciski.co/avery"},
